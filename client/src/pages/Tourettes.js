...
export default function Tourettes() {
  return (
    <div>
      <div>
        ...
        <div className="page-wrapper">
          ...
          <div className="page-container">
            ...
            <h5>Onset of Tics and Duration</h5>
            <p>
            ...
            <p>
              <strong>Simple tics:</strong> sudden, brief, repetitive movements that involve a limited number of muscle groups. They are more common than complex tics.
            </p>
            <p>
              <strong>Complex tics:</strong> distinct, coordinated patterns of movement involving several muscle groups.
            </p>
            <p>
              <strong>Examples of motor tics seen in Tourette syndrome</strong>
            </p>
            <ul>
              <li><strong>Simple motor tics</strong></li> include eye blinking and other eye movements, facial grimacing, shoulder shrugging, and head or shoulder jerking.
              <li><strong>Complex motor tics</strong></li> might include facial grimacing combined with a head twist and a shoulder shrug. Other complex motor tics may appear purposeful, including sniffing or touching objects, hopping, jumping, bending, or twisting.
            </ul>
            <p>
              <strong>Examples of vocal (phonic) tics in Tourette syndrome</strong>
            </p>
            <ul>
              <li><strong>Simple vocal tics</strong> include repetitive throat clearing, sniffing, barking, or grunting sounds.</li>
              <li><strong>Complex vocal tics</strong> may include repeating one’s own words or phrases, repeating others’ words or phrases (called echolalia), or more rarely, using vulgar, obscene, or swear words (called coprolalia).</li>
            </ul>
            <p>
            ...
            <h5>Disorders Associated with TS</h5>
            <p>
            ...
            <ul>
              <li>
                <strong>Attention Deficit Hyperactivity Disorder (ADHD)</strong>, including problems with concentration, hyperactivity, and impulsivity.
              </li>
              <li>
                <strong>Obsessive Compulsive Disorder or Behaviors (OCD/OCB):</strong> repetitive, unwanted thoughts, ideas, or sensations (obsessions) that make the person feel the need to perform behaviors repeatedly or in a certain way (compulsions). Repetitive behaviors can include handwashing, checking things, and cleaning, and can significantly interfere with daily life.
              </li>
              <li>
                <strong>Anxiety</strong> repetitive, unwanted thoughts, ideas, or sensations (obsessions) that make the person feel the need to perform behaviors repeatedly or in a certain way (compulsions). Repetitive behaviors can include handwashing, checking things, and cleaning, and can significantly interfere with daily life.
              </li>
              <li>
                <strong>Learning disabilities</strong> such as problems with reading, writing, and arithmetic that are not related to intelligence.
              </li>
              <li>
                <strong>Behavioral or conduct issues</strong>, including socially inappropriate behaviors, aggression, or anger.
              </li>
              <li>
                <strong>Problems falling or staying asleep.</strong>
              </li>
              <li>
                <strong>Social skills deficits and social functioning difficulties</strong>, such as trouble with social skills and with maintaining social relationships.
              </li>
              <li>
                <strong>Sensory processing issues</strong>, such as difficulty organizing and responding to sensory information related to touch, taste, smells, sounds, or movement.
              </li>
            </ul>
            <h5>Educational Setting</h5>
            <p>
            ...
            <h5>How is TS diagnosed?</h5>
            <p>
              To diagnose TS, a doctor looks for the following:
            </p>
            <ul>
              <li>Presence of both motor and vocal tics that occur several times a day, every day or intermittently for at least 1 year</li>
              <li>Onset of tics before age 18.</li>
              <li>Tics not caused by medications, other substances, or medical conditions.</li>
            </ul>
            <p>
            ...
            <ul>
              <li>
                <strong>Medications that block dopamine</strong> (drugs that may be used to treat psychotic and non-psychotic disorders) are the most consistently useful medications to suppress tics (for example, haloperidol and pimozide). These drugs may have or cause side effects and should be carefully managed by a physician or healthcare provider
              </li>
              <li>
                <strong>Alpha-adrenergic agonists</strong> such as clonidine and guanfacine. These medications are used primarily for hypertension (high blood pressure) but are also used in the treatment of tics.  These drugs may have or cause side effects and should be carefully managed by a physician or healthcare provider.
              </li>
              <li>
                <strong>Stimulant medications </strong> such as methylphenidate and dextroamphetamine can lessen ADHD symptoms in people with TS without causing tics to become more severe.  Previously, these drugs were not recommended for children with tics or TS and those with a family history of tics. Some studies show the short-term use of these drugs can help children with TS who also have ADHD.
              </li>
              <li>
                <strong>Antidepressants</strong> specifically, serotonin reuptake inhibitors (clomipramine, fluoxetine, fluvoxamine, paroxetine, and sertraline) have been proven effective in some people to control symptoms of depression, OCD, and anxiety.
              </li>
            </ul>
            <p>
