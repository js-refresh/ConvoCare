      ...
      <div>
        ...
        <div className="page-wrapper">
          ...
          <div className="page-container">
            ...
            <div className="note">
              <p>
                <strong>If you or someone you know is in crisis and needs immediate help,</strong> call the toll-free National Suicide Prevention Lifeline (NSPL) at 1-800-273-TALK (8255), 24 hours a day, 7 days a week.
              </p>
            </div>
            <br/>
            <p>
            ...
            <ul>
              ...
              <li>Intestinal distress and irritation from laxative ab</li>
            ...
            <ul>
              <li>Individual, group, and/or family psychotherapy</li>
              <li>Medical care and monitoring</li>
              <li>Nutritional counseling</li>
              <li>Medications</li>
            </ul>
            <h6>Psychotherapies</h6>
            <p>
            ...
            <h6>Medications</h6>
            <p>
              Evidence also suggests that medications such as antidepressants, antipsychotics, or mood stabilizers may also be helpful for treating eating disorders and other co-occurring illnesses such as anxiety or depression. Check the Food and Drug Administration’s (FDA) website: (<a href="https://www.fda.gov/" target="blank">http://www.fda.gov/</a>), for the latest information on warnings, patient medication guides, or newly approved medications.
            </p>
