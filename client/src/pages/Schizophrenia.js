      ...
      <div>
        ...
        <div className="page-wrapper">
          ...
          <div className="page-container">
            ...
            <h4>Onset and Symptoms</h4>
            <p>
              Schizophrenia is typically diagnosed in the late teen years to the early thirties and tends to emerge earlier in males (late adolescence – early twenties) than females (early twenties – early thirties). A diagnosis of schizophrenia often follows the first episode of <a href="https://www.nimh.nih.gov/health/publications/understanding-psychosis/index.shtml" target="blank">psychosis</a>, when individuals first display symptoms of schizophrenia. Gradual changes in thinking, mood, and social functioning often begin before the first episode of psychosis, usually starting in mid-adolescence. Schizophrenia can occur in younger children, but it is rare for it to occur before late adolescence.
            </p>
            <p>
              The symptoms of schizophrenia generally fall into the following three categories:
            </p>
            <p>
              <strong>Psychotic symptoms</strong> include altered perceptions (e.g., changes in vision, hearing, smell, touch, and taste), abnormal thinking, and odd behaviors. People with psychotic symptoms may lose a shared sense of reality and experience themselves and the world in a distorted way. Specifically, individuals typically experience:
            </p>
            <ul>
              <li>Hallucinations, such as hearing voices or seeing things that aren’t there</li>
              <li>Delusions, which are firmly held beliefs not supported by objective facts (e.g., paranoia - irrational fears that others are “out to get you” or believing that the television, radio, or internet are broadcasting special messages that require some response)</li>
              <li>Thought disorder, which includes unusual thinking or disorganized speech</li>
            </ul>
            <p>
              <strong>Negative symptoms</strong> include loss of motivation, disinterest or lack of enjoyment in daily activities, social withdrawal, difficulty showing emotions, and difficulty functioning normally. Specifically, individuals typically have:
            </p>
            <ul>
              <li>Reduced motivation and difficulty planning, beginning, and sustaining activities</li>
              <li>Diminished feelings of pleasure in everyday life</li>
              <li>“Flat affect,” or reduced expression of emotions via facial expression or voice tone</li>
              <li>Reduced speaking</li>
            </ul>
            <p>
              <strong>Cognitive symptoms</strong> include problems in attention, concentration, and memory. For some individuals, the cognitive symptoms of schizophrenia are subtle, but for others, they are more prominent and interfere with activities like following conversations, learning new things, or remembering appointments. Specifically, individuals typically experience:
            </p>
            <ul>
            ...
            <h5>Antipsychotic Medications</h5>
            <p>
            ...
            <h6>Here are some things you can do to help your loved one:</h6>
            <ul>
              <li>Help them get treatment and encourage them to stay in treatment</li>
              <li>Remember that their beliefs or hallucinations seem very real to them</li>
              <li>Tell them that you acknowledge that everyone has the right to see things their way</li>
              <li>Be respectful, supportive, and kind without tolerating dangerous or inappropriate behavior</li>
              <li>Check to see if there are any <a href="https://www.samhsa.gov/find-help/national-helpline" target="blank">support groups</a> in your area</li>
            </ul>
            <p>
            ...
            <ul>
              <li>Call 911 for emergency services or go to the nearest emergency room.</li>
              <li>Call the National Suicide Prevention Lifeline (Lifeline) at 1-800-273-TALK (8255) or text the Crisis Text Line (text HELLO to 741741).</li>
            </ul>
            <h5>Finding Help</h5>
            <p>
              The Substance Abuse and Mental Health Services Administration (SAMHSA) provides the <a href="https://findtreatment.samhsa.gov/" target="blank">Behavioral Health Treatment Services Locator</a> for finding mental health treatment facilities and programs. SAMHSA’s <a href="https://www.samhsa.gov/esmi-treatment-locator?page=7" target="blank">Early Serious Mental Illness Treatment Locator</a> provides information about treatment facilities that offer coordinated specialty care. For additional resources, visit the <a href="https://www.nimh.nih.gov/health/find-help/index.shtml" target="blank">NIMH Help for Mental Illnesses</a> page.
            </p>
