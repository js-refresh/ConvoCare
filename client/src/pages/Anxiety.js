    ...
    <div>
      ...
      <div className="page-wrapper">
        ...
        <div className="page-container">
          ...
          <ul>
            <li>Heart palpitations, a pounding heartbeat, or an accelerated heart rate</li>
            <li>Sweating</li>
          ...
          <h4>Phobia-related disorders</h4>
          <p>
            A <em>phobia</em> is an intense fear of or aversion to specific objects or situations. Although it can be realistic to be anxious in some circumstances, the fear people phobias feel is out of proportion to the actual danger caused by the situation or object.
          </p>
          <p>
            People with a phobia:
          </p>
          <ul>
            <li>May have an irrational or excessive worry about encountering the feared object or situation</li>
            <li>Take active steps to avoid the feared object or situation</li>
            <li>Experience immediate intense anxiety upon encountering the feared object or situation</li>
            <li>Endure unavoidable objects and situations with intense anxiety</li>
          </ul>
            <p>
              There are several types of phobias and phobia-related disorders:
            </p>
            <h5>Specific Phobias:</h5>
            <p>
            ...
            <ul>
              <li>Flying</li>
              <li>Heights</li>
              <li>Specific animals, such as spider, dogs, or snakes</li>
              <li>Receiving injections</li>
              <li>Blood</li>
            </ul>
            ...
            <h5>Separation anxiety disorder</h5>
            <p>
            ...
            <li>Some physical health conditions, such as thyroid problems or heart arrhythmias, or caffeine or other substances/medications, can produce or aggravate anxiety symptoms; a physical health examination is helpful in the evaluation of a possible anxiety disorder.</li>
            </ul>
            ...
            <p>
            A different type of anti-anxiety medication is <em>buspirone</em>. Buspirone is a non-benzodiazepine medication specifically indicated for the treatment of chronic anxiety, although it does not help everyone.
            </p>
            ...
            <h5>Choosing the Right Medication</h5>
            <p>
            ...
            <ul>
            <li>How well medications are working or might work to improve your symptoms</li>
            <li>Benefits and side effects of each medication</li>
            <li>Risk for serious side effects based on your medical history</li>
            <li>The likelihood of the medications requiring lifestyle changes</li>
            <li>Costs of each medication</li>
            <li>Other alternative therapies, medications, vitamins, and supplements you are taking and how these may affect your treatment; a combination of medication and psychotherapy is the best approach for many people with anxiety disorders</li>
            <li>How the medication should be stopped (Some drugs can’t be stopped abruptly and must be tapered off slowly under a doctor’s supervision).</li>
            </ul>
            <div className="note">
              <h6>Please Note:</h6>
              <p>
              Any information on this website regarding medications is provided for educational purposes only and may be outdated.  Diagnosis and treatment decisions should be made in consultation with your doctor.  Please visit the <a href="https://www.fda.gov/" target="blank">U.S. Food and Drug Administration</a> website for the latest information on warnings, patient medication guides, or newly approved medications.
              </p>
            </div>
            <br></br>
