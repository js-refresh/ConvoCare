...
export default function Thread() {
    ...
    const [activeEntry, setActiveEntry] = useState({ title: '', content: '', id: null })
    ...
    return (
        <div>
            ...
            <Container>
                <Row >
                    <Col className='user-profile-column' md={12} style={{ boxShadow: '0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23)'}}>
                        <h1 style={{color: '#026296'}}>ConvoCare Forum</h1>
                        <br/>
                        <h4>Connect with our community! Create a new discussion or comment on existing threads.</h4>
                        <div style={{ marginTop: '25px' }}>
                            <div className="Button">
                                <Button onClick={handleShow} style={{ float: 'right', marginBottom: '15px'}}>New Thread</Button>
                                ...
                                <Form onSubmit={handleSubmit}>
                                    <Modal.Body>
                                        <Form.Group controlId="exampleForm.ControlTextarea1">
                                            ...
                                            <Form.Control placeholder='Please title your thread'
                                                as="textarea"
                                                rows={1}
                                                name="title"
                                                ...
                                                value={form.title}
                                            />
                                            <Form.Label style={{marginTop: '5px'}}>Thread Body</Form.Label>
                                            <Form.Control type='content' placeholder='Write something to discuss with
                                            the community!'
                                                as="textarea"
                                                rows={3}
                                                name="content"
                            ...
                            <Card style={{
                                ...
                                //THREAD ENTRIES MAP BELOW
                                    ...
                                    {threadEntries.map((entry) =>
                                        ...
                                        <Card key={entry.id} style={{ width: '100%', marginBottom: '5px' }} onClick={() => handleShowEntry(entry)}>
                                            <Card.Body>
                                                <Card.Title>
                                                    {entry.title}
                                                    <span style={{ float: "right" }}>
                                                        {new Date(entry.createdAt).toString().split(" ").splice(0, 4).join(" ")}
                                                    </span>
                                                </Card.Title>
                                                <Card.Text>
                                                    {entry.content}
                                        ...
                                        >
                                            <Modal.Header closeButton>
                                                <Modal.Title><h3>{activeEntry.title}</h3></Modal.Title>
                                            </Modal.Header>
